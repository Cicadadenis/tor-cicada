...
mkdir build
cd build
cython3 ../tor-cicada.py --embed -o tor-cicada.c --verbose
if [ $? -eq 0 ]; then
...
gcc -Os -I /usr/include/python3.8 -o tor-cicada tor-cicada.c -lpython3.8 -lpthread -lm -lutil -ldl
if [ $? -eq 0 ]; then
